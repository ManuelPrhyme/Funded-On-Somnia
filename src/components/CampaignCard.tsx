      ...
      <div className="p-4">
        ...
        <div className="mb-3">
          <div className="flex justify-between text-sm mb-1">
            <span className="font-medium text-gray-900">{campaign.currentAmount.toFixed(3)} STT  </span>
            <span className="text-gray-500">raised of {campaign.goalAmount.toFixed(3)} STT</span>
          </div>
