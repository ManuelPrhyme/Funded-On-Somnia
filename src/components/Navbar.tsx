...
const Navbar: React.FC = () => {
  ...
  const { account, connectWallet, isConnecting, chainId, switchToShannonTest, disconnectWallet } = useWallet();
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Funded-On-Somnia</span>
            </Link>
